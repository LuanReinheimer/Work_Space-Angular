        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    const negociacao = new index_2.Negociacao(String(this._inputNome.val()), new Date(this._inputData.val().replace(/-/g, '/')), parseInt(this._inputQuantidade.val()), parseFloat(this._inputValor.val()));
                ...
                importarDados() {
                    ...
                    fetch('http://localhost:8080/dados')
                        ...
                        .then((dados) => {
                        dados
                            .map(dado => new index_2.Negociacao(dado.nome, new Date(), dado.vezes, dado.montante))
            ...
            ], NegociacaoController.prototype, "_inputNome", void 0);
            __decorate([
